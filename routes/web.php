...
Route::get('stocks',[StockController::class,'index'])->name('stocks.create');
...
Route::get('trades',[TradeController::class,'index'])->name('trades.create');
...
Route::get('balances',[BalanceController::class,'index'])->name('balances.create');
