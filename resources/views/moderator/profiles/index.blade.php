                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 profile-left">
                            <div class="col-12">
                                <figure class="profile-pic">
                                    @if($profile->avatar == "default-pp.png")
                                        <img src=" {{ asset('img/default.svg') }} " width="125px" height='125px' style="object-fit: cover;" class = "rounded-circle">
                                    @else
                            ...
                            <div class="col-12 id-left">
                                <h4> {{ $moderator[0]->name }} {{ $profile->surname }} </h4>
                            </div>
                        </div>
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="col-12 profile-btns">    
                                <div>
                                    <a class="prf-home" href="{{ route('moderator.home') }} " title="Back home">
                                        <i class="fas fa-home"></i>
                                    </a>
                                </div>
                                <div>
                                    <a class="prf-edit" href="{{ route('moderator.profiles.edit', $profile->id) }} " title="Edit my profile">
                            ...
                            <div class="col-12">    
                                <div class="prf-data">
                                    ...
                                    <div class="personal-dt">
                                        <h6>Employee number: </h6> <p>{{ $moderator[0]->emp_number }}</p>
                                    </div>
                                    <div class="personal-dt">
                                        <h6>Salary: </h6> <p>{{ $moderator[0]->salary }}€</p>
                                    </div>
                                    <div></div>
                                </div>
                            </div>
                            ...
                            <div class="col-12 responsive-thread">
                                <div class="{{ $switch_bcg }} post">
                                    ...
                                    <div class="post-header">
                                        ...
                                        <div class="post-data">
                                            <div class=" ">
                                                <p>{{ $moderator[0]->name }} {{ $profile->surname }}</p>
                                            </div>   
                                            <div class="post-date">
                                                <p>{{$post->updated_at}}</p>        
                                            </div>                         
