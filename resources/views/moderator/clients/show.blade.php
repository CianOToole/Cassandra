                ...
                <div class="card-body">
                    ...
                    <div class="" style="float: right">
                        ...
                        @if($client[0]->isBanned == 0)
                            <form method="POST" action="{{ route('moderator.banning', $client[0]->id) }}" style="display: inline-block">
                        ...
                        @else
                            <form method="POST" action="{{ route('moderator.unban', $client[0]->id) }}" style="display: inline-block">
                                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                <input type="hidden" name="_method" value="PUT">
